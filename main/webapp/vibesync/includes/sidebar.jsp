...
.follow_items.show::-webkit-scrollbar{
  display:none;
}
...
<style> /* 팔로잉/팔로워/메시지목록 모달창 */
    ...
    .modal-follow-content {
        ...
        width: 92%; max-width: 415px; min-width: 310px;
        min-height: 310px; max-height: 78vh;
        display: flex;
        flex-direction: column;
        padding-bottom: 13px;
        border: none;
    ...
    .modal-follow-tab-btn.active {
        color: var(--font-color); /* 활성화된 탭 색상 */
        border-bottom: 2px solid #3498db; /* 활성화된 탭 밑줄 */
    }
    ...
    .follow-list-item:hover {
        background-color: var(--hover-color); /* 호버 시 배경색 */
    }
